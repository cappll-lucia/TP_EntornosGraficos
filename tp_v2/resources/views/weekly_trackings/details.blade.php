                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (auth()->user()->role_id == '1' && $wt->is_editable == 1)
                                    <br>
                                    <form id="uploadForm" action="{{ route('wt.saveFile', ['id' => $wt->id]) }}"
                                        method="POST" enctype="multipart/form-data" class="border rounded shadow-sm p-4">
                                        @csrf
                                        <div class="mb-3">
                        ...
                        success: function(response) {
                            Swal.fire({
                                ...
                                text: response.message ||
                                    'El seguimiento ha sido aprobado correctamente.',
                            }).then(() => {
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                ...
                                text: xhr.responseJSON?.message ||
                                    'Hubo un problema al aprobar el seguimiento.',
                            });
                        },
                        complete: function() {
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: `{{ route('wt.reject', ':id') }}`.replace(':id',
                                    id),
                                method: 'POST',
                                data: {
                                    _token: "{{ csrf_token() }}",
                                ...
                                success: function(response) {
                                    Swal.fire({
                                        ...
                                        title: '¡Éxito!',
                                        text: response.message ||
                                            'El seguimiento ha sido rechazado correctamente.',
                                    }).then(() => {
                                        location.reload();
                                    });
                                },
                                error: function(xhr) {
                                    Swal.fire({
                                        ...
                                        title: xhr.responseJSON?.title ||
                                            'Error!',
                                        text: xhr.responseJSON?.message ||
                                            'Hubo un problema al rechazar el seguimiento.',
                                    });
                                },
                                complete: function() {
                                    $("#loadingSpinner").addClass('d-none');
