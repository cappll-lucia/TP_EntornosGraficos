...
<style>
    ...
    /* Asegurarte de que la card de registro no exceda el ancho de la pantalla */
    .card {
        max-width: 100%;
        margin: 0 auto;
        /* Centrar la card */
    ...
    /* En pantallas pequeñas, la card debería ocupar el 90% o 100% del ancho */
    @media (max-width: 768px) {
        .card {
            width: 90% !important;
            /* O puedes usar 100% dependiendo de lo que prefieras */
        }
    }
</style>
