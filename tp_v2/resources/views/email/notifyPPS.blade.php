                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;">
                                                                        <img src="https://www.utn.edu.ar/images/logo-utn.png" alt="Logo-UTN"title="UTN"style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 540px;"width="540" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"style="overflow-wrap:break-word;word-break:break-word;padding:20px 90px 30px 60px;font-family:arial,helvetica,sans-serif;">
                                                            <div class="v-font-size"style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <span style="line-height: 19.6px;">Hola, {{$responsible_name}}</span>
                                                                </p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">
                                                                    <span style="line-height: 19.6px;">
                                                                        Te notificamos por este medio que se ha cargado una nueva solicitud de inicio de PPS.
                                                                    </span>
                                                                </p>
                                                                <p style="line-height: 140%;">
                                                                    <span style="line-height: 19.6px;">
                                                                        Para ver mas detalles ingresa a https://tpentornosgraficos-production.up.railway.app/.
                                                                    </span>
                                                                </p>
                                                            </div>
