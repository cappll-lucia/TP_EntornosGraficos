                                                            ...
                                                            <div class="v-font-size"style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <p style="line-height: 140%;">
                                                                    <span style="line-height: 19.6px;">
                                                                        Nos complace anunciarte que hemos finalizado la solicitud número #{{$pps_number}}, correspondiente al alumno/a {{$student_name}}.
                                                                    </span>
                                                                </p>
                                                                <p style="line-height: 140%;">
                                                                    <span style="line-height: 19.6px;">
                                                                        Para ver mas detalles ingresa a la página o contáctate con {{$responsible_email}}.
                                                                    </span>
                                                                </p>
                                                            </div>
