                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($pps->responsible_id != null)
                                                    {{ $pps->Responsible->last_name }},
                                                    {{ $pps->Responsible->first_name }}
                                                @else
                                                    Sin asignar
                                                @endif
                                            </td>
                                                        ...
                                                        <select id="TeacherSelect" name="TeacherSelect"
                                                            ...
                                                            @foreach ($teachers as $teach)
                                                                <option value="{{ $teach->id }}"
                                                                    @if ($teach->id == $pps->teacher_id) selected @endif>
                                                ...
                                                @if (auth()->user()->role_id == '1' && $pps->is_editable == true)
                                                    <div class="mt-2">
                                                        ...
                                                        <input id="file" name="file" type="file"
                                                            class="w-75 form-control" accept=".pdf" />
                                                    </div>
                                                @endif
                                            </td>
                                        </tr>
                                        @if (auth()->user()->role_id == '1' && $pps->is_editable == true)
                                            <form action={{ route('pps.update', ['id' => $pps->id]) }} id="form_data"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="date" id="DatePickerFrom"
                                                            class="w-50 form-control" name="DatePickerFrom"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea id="description" name="description" class="mt-2 w-75 form-control" rows="3">
                                                                                                                                                                                                                                                                                                    {{ $pps->description }}
                                                                                                                                                                                                                                                                                                </textarea>
                            ...
                            success: function(response) {
                                Swal.fire({
                                    ...
                                    text: response.message ||
                                        'La solicitud ha sido finalizada correctamente.',
                                }).then(() => {
