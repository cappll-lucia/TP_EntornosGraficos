    ...
    <div class=" font-sans page antialiased" style="--bs-bg-opacity:.5">
        ...
        <div class="bg-light mx-auto mb-3 card">
          <div class="flex-row card-header d-flex justify-content-between align-items-center ">
            ...
            <button type="button submit" class="right-0 btn btn-success d-block"> <a href="{{ route('createResponsible') }}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-between align-items-center pe-4">
                                            <a href="{{route('editResponsible', ['id' => $responsible->id])}}"><i class="fa-solid fa-pen"></i></a>
                                            <a class="btn" data-bs-toggle="modal" data-bs-target="#deleteResponsibleModal{{ $responsible->id }}"><i class="fa-solid fa-trash"></i></a>

                                            <!-- Modal -->
                                            <div class="modal fade" id="deleteResponsibleModal{{ $responsible->id }}" tabindex="-1" aria-labelledby="deleteResponsibleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ¿Está seguro de eliminar el responsable <b>{{ $responsible->last_name }}, {{ $responsible->first_name }}</b>?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                            <form action="{{ route('deleteResponsible', ['id' => $responsible->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
        ...
        <div class="modal " id="delete-responsible-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <span>
          ...
          ¿Está seguro de eliminar el responsable <b style="font-style: italic">{{$responsible->last_name}}, {{$responsible->first_name}}</b>?
        </span>
      </div>
      <div class="modal-footer">
