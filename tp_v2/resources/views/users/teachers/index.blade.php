...
@section('content')
    <div class=" page font-sans antialiased dark:bg-black dark:text-white/50" style="--bs-bg-opacity:.5">
        ...
        <div class="bg-light mx-auto mb-3 card">
          <div class="card-header d-flex justify-content-between flex-row align-items-center ">
            <h3 class=" h3 mt-2 text-center card-title">Docente</h3>
            @if(Auth::check() && Auth::user()->role_id===4)
            <button type="button submit" class="btn btn-success d-block right-0"> <a href="{{ route('createTeacher') }}">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="h5 modal-title" id="deleteTeacherModalLabel">Eliminar Docente</h5>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="h1 modal-title fs-5" id="exampleModalLabel">Eliminar Docente</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <span>
      ...
      <div class="modal-footer">
                   <a type="button" class="btn btn-outline-secondary w-50 me-1" href="{{ route('getTeachers') }}">
                Cancelar
            </a>
          <button type="submit ml-3" class="btn btn-outline-primary w-50 ms-1">
